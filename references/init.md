...
4. **规则与风格**：写根 AGENTS（必读 CONVENTIONS 提示、参考文档、纠正回路及其落点表、测试规则与验证流程）与模块 AGENTS（核心原则、参考文档、验证入口），以 [../assets/style/](../assets/style/) 模板为起点写模块核心原则并为每个模块建 `CONVENTIONS.md`（见 [style.md](style.md)，先用偏好清单填充），加 PR 模板。
